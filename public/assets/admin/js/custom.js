  ...
  if (typeof selectorObj != 'undefined') {
    ...
    if (windowWidth === 375) {
      $.each(selectorObj, function (key, val) {
        $(val + ' + .bootstrap-datetimepicker-widget.dropdown-menu').addClass('dtPicker375-' + modulePrefix);
      });
    }

    if (windowWidth === 360) {
      $.each(selectorObj, function (key, val) {
        $(val + ' + .bootstrap-datetimepicker-widget.dropdown-menu').addClass('dtPicker360-' + modulePrefix);
      });
    } else if (windowWidth === 320) {
      $.each(selectorObj, function (key, val) {
        $(val + ' + .bootstrap-datetimepicker-widget.dropdown-menu').addClass('dtPicker320-' + modulePrefix);
      });
    }
  }
};
...
$(document).ready(function () {
  ...
  var hasActiveMenu = $(document).find('.nav-item.has-treeview ul li a').hasClass('active');
...
module.exports = __webpack_require__(/*! E:\xampp_7.2\htdocs\AllGym\portal-v2.0\resources\assets\admin\js\custom.js */"./resources/assets/admin/js/custom.js");

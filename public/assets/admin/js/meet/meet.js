...
/***/ "./resources/assets/admin/js/meet/meet.js":
/*!************************************************!*\
  !*** ./resources/assets/admin/js/meet/meet.js ***!
  \************************************************/
...
$(document).ready(function () {
  var tbl = $('#meetsTbl').DataTable({
    processing: true,
    serverSide: true,
    ajax: {
      url: meetsUrl,
      data: function data(_data) {
        _data.sanction_type = $('#filterSanction').find('option:selected').val();
        _data.from_date = $('#fromDate').val();
        _data.to_date = $('#toDate').val();
        _data.state = $('#filterState').val();
        _data.status = $('#filterStatus').val();
      }
    },
    "order": [[0, "asc"]],
    "columnDefs": [{
    ...
    columns: [{
      ...
      data: function data(row) {
        ...
        if (now < row.end_date) {
          ...
          return prepareTemplateRender('#meetFeaturedTemplate', data);
        }
      },
      name: 'is_featured'
    }, {
    ...
    'fnInitComplete': function fnInitComplete() {
      $('#filterSanction').change(function () {
        $('#meetsTbl').DataTable().ajax.reload(null, true);
      });
...
/***/ 57:
/*!******************************************************!*\
  !*** multi ./resources/assets/admin/js/meet/meet.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\xampp_7.2\htdocs\AllGym\portal-v2.0\resources\assets\admin\js\meet\meet.js */"./resources/assets/admin/js/meet/meet.js");

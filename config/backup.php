...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('APP_ADMIN_EMAIL', 'admin@allgymnastics.com'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'admin@allgymnastics.com'),
                'name' => env('MAIL_FROM_NAME', 'AGV2.0 Backups'),
            ],
        ],

...
class CreateRegistrationCoachVerificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registration_coach_verifications', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('registration_coach_verifications');
    }
}

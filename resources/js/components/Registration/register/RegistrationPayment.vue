<template>
    <div>
        ...
        <div v-if="this.registrationData != null && this.gymDetails != null">
                    ...
                    <div class="modal-body">
                        <table class="table table-sm table-striped border-1 mb-0">
                            ...
                            <tr class="check-details-tr">
                                ...
                                <td>
                                    {{ this.registrationData.meet.name }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    {{ this.registrationData.meet.primary_contact_email }}
                                </td>
                            </tr>
                            <tr>
                                <td>
        ...
        <div v-if="paymentProcessedMessage != null">
            ...
            <div class="alert alert-success">
                ...
                <div class="text-right">
                    <a :href="'/gyms/' + registrationData.gym + '/registration/' + registrationId"
        ...
        <div v-else>
            ...
            <div v-else>
                <div v-if="waitlist" class="alert alert-warning">
                    <span class="fas fa-exclamation-triangle"></span>
                    Some of your athletes are entering the waitlist for this meet.
                    You will not be charged right now for those athletes.<br/>
                </div>

                <div v-if="(paymentOptions != null) && (registrationData != null)">
                    <div>
                                ...
                                <div v-if="optionsExpanded == 'check'">
                                    ...
                                    <div class="small ml-3 d-flex flex-row flew-nowrap">
                                        <div class="d-inline-block">
                                            ...
                                            <span class="m-0">
                                                {{ registrationData.meet.mailed_check_instructions }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="paymentType" id="fullAmount" value="0" checked="checked">
                                                <label class="form-check-label" for="fullAmount">
                                                    <span class="fas fa-money-check"></span> Full Amount.
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div v-if="registrationData.meet.accept_deposit" class="row">
                                        <div class="col mb-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="paymentType" id="deposit" value="1" v-model="deposit">
                                                <label class="form-check-label" for="deposit">
                                                    <span class="fas fa-money-check"></span> Deposit - {{ registrationData.meet.deposit_ratio }}%.
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="display:none;" id="notelabel">
                                        <div class="col mb-1">
                                            <span>
                                                *Note: The host requests a {{ registrationData.meet.deposit_ratio }}% deposit to enter into the meet. Full payment is 
...
<!--                                </div>-->
                        ...
                        <div v-if="display_div">
                            ...
                            <div v-if="summary.processor > 0" class="row">
                                <div class="col">
                                    <span class="fas fa-fw fa-file-invoice"></span> Payment Processor Fee ({{this.chosenMethod.fee}}%):
                                        <span data-toggle="tooltip"
                        ...
                        <div v-if="summary.discount > 0" class="row">
                            <div class="col">
                                <span class="fas fa-fw fa-file-invoice"></span> Discount :
                            </div>
                            <div class="col">
                                ${{ numberFormat(summary.discount) }}
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="d-inline-block">
                                    <button class="btn btn-sm btn-success"
                                        ...
                                        <span class="fas fa-file-signature"></span> Register
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            printCheckDetails(){
              window.open('/meet/'+ this.registrationData.meet.id +'/gym/'+this.registrationData.gym+'/print-check-sending-details','blank')
            },
            ...
            recalculateTotals(deposit_ratio = 100, previous_deposit = 0) {
                ...
                if (
                    ...
                    return;
                this.summary = {
                    subtotal: (deposit_ratio == 100 ? this.registrationData.total : (this.registrationData.total * deposit_ratio)/100),
            ...
            submitRegistration() {
                ...
                this.confirmAction(
                    ...
                    () => {
                        ...
                        axios.post(
                            '/api/registration/register/' + this.registrationData.meet.id + '/' +
                            this.registrationData.gym,
                            {
                                '__managed': this.managed,
                                levels: this.registrationData.levels,
                            ...
                            this.registrationId = result.data.registration;
                        }).catch(error => {
                            let msg = '';
                            if (error.response) {
                                msg = error.response.data.message;

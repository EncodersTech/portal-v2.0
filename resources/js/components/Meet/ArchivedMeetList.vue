    ...
    <div>
        ...
        <div :class="{'d-none': isLoading || isError }">
            ...
            <div class="alert alert-info" :class="{ 'd-none': !hasNoItems }">
                <span class="fas fa-info-circle"></span> You do not have any archived {{ plural }}
                ...
                <table class="table table-sm table-striped">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" class="align-middle clickable" @click="sortBy('updated_at')">
                                Updated
                                ...
                                <div class="d-inline-block" v-if="permissions.edit">
                                    <div class="mb-1 mr-1 d-inline-block">
                                        <button class="btn btn-sm btn-primary" title="Restore"
                                            ...
                                            <span class="fas fa-fw fa-box-open"></span>
                                        </button>
                                        <form :action="'/gyms/' + gym + '/meets/' + item.id + '/restore'"
                                            :ref="'restore_' + item.id" method="POST">
...
<script>
    ...
    export default {
            ...
            restoreItem(item) {
                this.confirmAction(
                    ...
                    'fas fa-question-circle', () => {
                        this.isBusy = true;
                        this.$refs['restore_' + item.id][0].submit();
                    },
                    this
                );
            },
        ...
        mounted() {
            ...
            axios.get('/api/gyms/' + this.gym + '/meets/archived', {
                'params': {

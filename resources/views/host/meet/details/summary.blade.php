    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="text-right m-3">
                <a class="btn btn-info" href="{{route('athlete.summary-report',$meet->id)}}" target="_blank">Print</a>
...
<div class="modal fade" id="total-coaches-summary-model" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="text-right m-3">
                <a class="btn btn-info" href="{{route('coach.summary-report',$meet->id)}}" target="_blank">Print</a>
                <a class="btn btn-secondary" data-dismiss="modal" aria-label="Close">Cancel</a>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="total-gym-summary-model" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="text-right m-3">
                <a class="btn btn-info" href="{{route('gym.summary-report',$meet->id)}}" target="_blank">Print</a>
                <a class="btn btn-secondary" data-dismiss="modal" aria-label="Close">Cancel</a>
            </div>
        </div>
    </div>
...
{{--                        <h5>Registered Athletes, Coaches and Gyms over time</h5>--}}
{{--                    </div>--}}
{{--                    <div style="text-align: center; font-size: xx-large" class="lineChartSpinner">--}}
{{--                        <i class="fas fa-sync fa-spin text-center"></i>--}}
{{--                    </div>--}}
{{--                    <div id="meet-summary-line-chart-container" class="pt-2">--}}
{{--                        <canvas id="meet-line-chart-report"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                <div class="card-body">--}}
{{--                    <div class="col-sm-6 col-md-6 col-lg-6 pt-2">--}}
{{--                        <h5>Total Earning over time</h5>--}}
{{--                    </div>--}}
{{--                    <div style="text-align: center; font-size: xx-large" class="barChartSpinner">--}}
{{--                        <i class="fas fa-sync fa-spin text-center"></i>--}}
{{--                    </div>--}}
{{--                    <div id="meet-summary-bar-chart-container" class="pt-2">--}}
{{--                        <canvas id="meet-bar-chart-report"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                        <h5>Sanction Body wise count</h5>--}}
{{--                    </div>--}}
{{--                    <div id="meet-summary-pie-chart-container" class="pt-2">--}}
{{--                        <canvas id="meet-pie-chart-report"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}

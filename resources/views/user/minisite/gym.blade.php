    ...
    <div class="row">
        <div class="col-sm-2 mb-3">
            <a href="{{ $gym->profile_picture }}" target="_blank">
                <img id="profile-picture-display" src="{{ $gym->profile_picture }}" class="rounded profile-picture-256"
                    alt="Gym Picture">
            </a>
        </div>
        ...
        <div class="col">
            ...
            @if (($gym->usag_membership != null) || ($gym->usaigc_membership != null) || ($gym->aau_membership != null)
            || ($gym->nga_membership != null))
            <div class="row mt-2">
                <div class="col">
            ...
            <div class="row">
                <div class="col text-right">
                    ...
                    <div class="mb-2 mr-2 d-inline-block">
                        <a href="{{ route('gyms.edit', ['gym' => $gym ]) }}" class="btn btn-success" title="Edit">

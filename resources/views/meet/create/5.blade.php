<div class="row">    
    <div class="col">
        <form method="POST" action="{{ route('gyms.meets.store.5', ['gym' => $gym, 'temporary' => $tm]) }}">
            @csrf
            ...
            <div class="row">
                <div class="col-lg mb-3">
                    ...
                    <input id="primary_contact_first_name" name="primary_contact_first_name"
                        ...
                        value="{{ $tm->oldOrValue('primary_contact_first_name') }}"
                ...
                <div class="col-lg mb-3">
                    ...
                    <input id="primary_contact_last_name" name="primary_contact_last_name"
                        ...
                        value="{{ $tm->oldOrValue('primary_contact_last_name') }}"
            ...
            <div class="row">
                <div class="col-lg mb-3">
                    ...
                    <input id="primary_contact_email" name="primary_contact_email"
                        ...
                        value="{{ $tm->oldOrValue('primary_contact_email') }}"
            ...
            <div class="row">
                <div class="col-lg mb-3">
                    ...
                    <input id="primary_contact_phone" type="text" name="primary_contact_phone"
                        ...
                        value="{{ $tm->oldOrValue('primary_contact_phone') }}"
                ...
                <div class="col-lg mb-3">
                    ...
                    <input id="primary_contact_fax" type="text" name="primary_contact_fax"
                        ...
                        value="{{ $tm->oldOrValue('primary_contact_fax') }}"
                ...
                <div class="col">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox"
                            ...
                            {{ $tm->oldOrValue('get_mail_primary') ? 'checked' : '' }}>
                    ...
                    <h5 class="border-bottom">
                        <div class="form-check mb-1">
                            <input class="form-check-input" type="checkbox"
                                ...
                                {{ $tm->oldOrValue('secondary_contact') ? 'checked' : '' }}>
            ...
            <div class="secondary-info-fields">
                ...
                @else
                    <div class="row mb-2">
                        <div class="col-lg mb-1 text-info font-weight-bold">
                ...
                <div class="row">
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_first_name" name="secondary_contact_first_name"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_first_name') }}"
                            type="text"
                            required autofocus>
                    ...
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_last_name" name="secondary_contact_last_name"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_last_name') }}"
                            type="text" required>
                ...
                <div class="row">
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_email" name="secondary_contact_email"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_email') }}"
                    ...
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_job_title" name="secondary_contact_job_title"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_job_title') }}"
                ...
                <div class="row">
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_phone" type="text" name="secondary_contact_phone"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_phone') }}"
                    ...
                    <div class="col-lg mb-3">
                        ...
                        <input id="secondary_contact_fax" type="text" name="secondary_contact_fax"
                            ...
                            value="{{ $tm->oldOrValue('secondary_contact_fax') }}"
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                ...
                                {{ $tm->oldOrValue('secondary_cc') ? 'checked' : '' }}>
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox"
                                ...
                                {{ $tm->oldOrValue('get_mail_secondary') ? 'checked' : '' }}>

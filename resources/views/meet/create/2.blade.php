            ...
            <div class="row">
                ...
                <div class="col-lg mb-3">
                    ...
                    <input type="text" :class="'form-control form-control-sm'"
                        ...
                        value="{{
                                    $tm->oldOrValue('registration_first_discount_amount') != null ?
                                    number_format($tm->oldOrValue('registration_first_discount_amount'), 2) :
                                    0
                                }}"
                    ...
                    <h5 class="border-bottom">
                        <div class="form-check mb-1">
                            <input class="form-check-input" type="checkbox" name="registration_second_discount_is_enable"
                                ...
                                {{ $tm->oldOrValue('registration_second_discount_is_enable') != null ? 'checked' : '' }} >
            ...
            <div class="row">
                <div class="col-lg mb-3">
                    <label for="registration_second_discount_end_date" class="mb-1" ref="registration_second_discount_end_date"
                        data-value="{{ $tm->oldOrValue('registration_second_discount_end_date') }}">
                        <span class="fas fa-fw fa-calendar-alt"></span>
                ...
                <div class="col-lg mb-3">
                    ...
                    <input type="text" :class="'form-control form-control-sm'"
                        ...
                        value="{{ $tm->oldOrValue('registration_second_discount_amount') == null ? 0 : number_format($tm->oldOrValue('registration_second_discount_amount'),2) }}"
                    ...
                    <h5 class="border-bottom">
                        <div class="form-check mb-1">
                            <input class="form-check-input" type="checkbox" name="registration_third_discount_is_enable"
                                ...
                                {{ $tm->oldOrValue('registration_third_discount_is_enable') != null ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-lg mb-3">
                    <label for="registration_third_discount_end_date" class="mb-1" ref="registration_third_discount_end_date"
                        data-value="{{ $tm->oldOrValue('registration_third_discount_end_date') }}">
                        <span class="fas fa-fw fa-calendar-alt"></span>
                ...
                <div class="col-lg mb-3">
                    ...
                    value="{{ $tm->oldOrValue('registration_third_discount_amount') == null ? 0 : number_format($tm->oldOrValue('registration_third_discount_amount'),2) }}"

    ...
    <div class="col-xl-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">&#36; {{ number_format($summaryDataThisYear['total_earn'], 2) }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{ $summaryDataThisYear['total_ath'] }} Athletes</span>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{ $summaryDataThisYear['total_coa'] }} Coaches</span>
                <span class="info-box-summary"><a class="text-decoration-none" href="" data-toggle="modal"
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{ $summaryDataThisYear['total_gym'] }} Gyms</span>
                <span class="info-box-summary"><a class="text-decoration-none" href="" data-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <div class="p-2">
                <table class="table table-bordered" id="athleteLevelSummaryTbl">
                    ...
                    @if(count($summaryDataThisYear['athleteLevelArr']) > 0)
                        @foreach($summaryDataThisYear['athleteLevelArr'] as $level => $count)
                            <tr>
        ...
        <div class="modal-content">
            ...
            <div class="p-2">
                <table class="table table-bordered" id="coachSummaryTbl">
                    ...
                    @if(count($summaryDataThisYear['coachSummaryArr']) > 0)
                        @foreach($summaryDataThisYear['coachSummaryArr'] as $coachKey => $coachArr)
                            <tr>
                                <td class="text-center">{{$loop->iteration}}</td>
        ...
        <div class="modal-content">
            ...
            <div class="p-2">
                <table class="table table-bordered" id="gymSummaryTbl">
                    ...
                    @if(count($summaryDataThisYear['gymSummaryArr']) > 0)
                        @foreach($summaryDataThisYear['gymSummaryArr'] as $gymData)
                            <tr>

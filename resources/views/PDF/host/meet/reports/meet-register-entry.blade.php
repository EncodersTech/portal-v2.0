...
<body>
    <div class="header">
        ...
        <div class="logo-container">
            ...
            <h5 class="table-header">{{ $registrations->gym->name }}</h5>
            <table class="table-0 full-width">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-3">
                            {{ $registrations->gym->office_phone }}
                        </td>
                        <td class="col-3">
            ...
            @if($registrations->specialists->count() > 0)
                ...
                <table class="table-0 full-width">
                    ...
                    <tbody>
                        ...
                        @foreach ($registrations->specialists as $a)
                            <tr style="{{ $loop->even?'background-color: #ccc;':'' }}">
                                <td class="col-1">
                                    {{ $a->fullName() }}
                                </td>

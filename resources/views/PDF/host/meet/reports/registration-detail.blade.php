...
<body>
    ...
    @if ($meet)
    <h4 class="table-header">Meet Details</h4>
    <table class="table-0 full-width">
        <thead>
            <tr>
                <th class="col-2" style="width: 8%">Meet Name</th>
                <th class="col-2">Meet Host</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="col-3">
                    {{ $meet->created_at->format(Helper::AMERICAN_SHORT_DATE) }}
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="float-parent" style="padding: 0 !important;">

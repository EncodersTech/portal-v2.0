...
<body>
    ...
    <div class="float-parent" style="padding-top: 20px !important;">
    <span><strong>New Athlete Registrations: {{count($changes['athlete']['new'])}}</strong></span><br>
    <!-- <h4></h4> -->
    <table style="table-0 full-width">
        <thead>
            <tr>
    ...
    <div class="float-parent" style="padding-top: 20px !important;">
        <span><strong>Athlete Change Level: {{count($changes['athlete']['moved'])}}</strong></span><br>
        <!-- <h4></h4> -->
        <table class="table-0 full-width">
            <thead>
                <tr>
                    <th class="">First Name</th>
                    <th class="">Last Name</th>
                    <th class="">Previous Level</th>
                    <th class="">New Level</th>
                    <th class="">Sanction</th>
                </tr>
            </thead>

<div>
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    @if(!empty($sourceBankAccounts))
                        @foreach($sourceBankAccounts as $bankAccount)
                            @if($bankAccount->type == 'bank')
                                <div class="py-1 px-2 mb-2 border bg-white rounded">
                                    <div class="form-check">
                                        <input type="checkbox" id="source_wallet_bank_{{ $bankAccount->id }}" class="form-check-input">
                                        <label for="source_wallet_bank_{{ $bankAccount->id }}" class="form-check-label">
    ...
    @if(!empty($sourceBankAccounts))
        @foreach($sourceBankAccounts as $bankAccount)
            @if($bankAccount->type == 'balance')
                <div class="py-1 px-2 mb-2 border bg-white rounded">
                    <div class="form-check">
                        <input type="checkbox" id="source_wallet_balance" class="form-check-input">
                        <label for="source_wallet_balance" class="form-check-label">
    ...
    <div class="py-1 px-2 mb-2 border bg-white rounded">
        <div class="form-check">
            <input type="checkbox" id="allGym_source_balance" class="form-check-input" value="12">

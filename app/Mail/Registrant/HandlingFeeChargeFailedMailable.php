...
class HandlingFeeChargeFailedMailable extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        return $this->from(config('mail.from.address'))
                    ->subject(
                        'Handling Fee Charge Failed - Update you card'
                    )->markdown('emails.registration.handling_fee_charge_failed');
    }

...
class ClearWithdrawBalance extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'withdraw-balance:clear';
     ...
     * @var string
     */
    protected $description = 'Clears pending users\' withdraw balance';
    ...
    {
        try {
            $this->info('clear pending withdraw balance start...');
            $now = now()->addHours(12); /** @var Carbon $now */
            UserBalanceTransaction::where('type', UserBalanceTransaction::BALANCE_TRANSACTION_TYPE_WITHDRAWAL)
            ...
            $this->info('clear pending withdraw balance end...');
        } catch(\Throwable $e) {

...
Route::middleware(['auth', 'verified','checkUserActive'])->group(function () {
    ...
    Route::middleware(['permission:access_report'])->group(function () {
        Route::middleware('throttle:5000,1')->get('/gym/{gym}/registration/{registration}/report/{reportType}', 'MeetRegistrationController@reportCreate');

        Route::middleware('throttle:5000,1')->get('/host/{hostingGym}/meets/{meet}/report/{reportType}/create/{gym?}', 'MeetController@hostReportCreate');
